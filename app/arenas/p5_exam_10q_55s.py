...
# Constants
# ---------------------------
ARENA_VER = "P5_EXAM_10Q_55S__SAME_SENTENCE_TWO_BLANKS__2026-01-27"
...
<div class="p5hud {shake_class}">
  <div class="p5hudTop">
    <div class="p5title">🔥 P5 EXAM 10Q · 55s</div>
    <div class="p5badges">
...
<div class="p5qBox">
  ...
  <div class="p5qText">{q.prompt_b}</div>
    ...
    with right:
        ...
        # (Title removed intentionally for clean UI)
        ...
        # (Bottom mobile guide removed intentionally)
