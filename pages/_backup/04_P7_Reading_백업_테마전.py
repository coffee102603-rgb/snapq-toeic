...
section[data-testid="stSidebar"]{background:#050010!important;}
button[kind="secondary"],button[kind="secondary"]:active,button[kind="secondary"]:focus{background:linear-gradient(135deg,#0f0020,#18003a)!important;border:2px solid #9B59B6!important;color:#fff!important;}
button[kind="secondary"] p,button[kind="secondary"] span{color:#fff!important;}
button[kind="primary"],button[kind="primary"]:active{background:linear-gradient(135deg,#0f0020,#18003a)!important;border:2px solid #9B59B6!important;color:#fff!important;}
button[kind="primary"] p,button[kind="primary"] span{color:#fff!important;}
.p7-sent,.p7-sent *{color:#fff!important;}
...
/* 전투 버튼 */
button[kind="primary"]{background:#0a0012!important;color:#fff!important;border:2px solid #7C3FBE!important;border-radius:14px!important;font-size:2.1rem!important;font-weight:900!important;padding:1.2rem 1.4rem!important;box-shadow:0 0 12px rgba(124,63,190,0.3)!important;text-shadow:none!important;text-align:center!important;}
button[kind="primary"] p{font-size:2.1rem!important;font-weight:900!important;text-align:center!important;}
button[kind="secondary"]{background:#0a0012!important;color:#fff!important;border:2px solid #7C3FBE!important;border-radius:14px!important;font-size:2.1rem!important;font-weight:900!important;padding:1.2rem 1.4rem!important;box-shadow:0 0 12px rgba(124,63,190,0.25)!important;text-shadow:none!important;text-align:center!important;}
button[kind="secondary"] p{font-size:2.1rem!important;font-weight:900!important;text-align:center!important;}

/* P7 지문 카드 */
.p7-pass{background:#080010;border:2px solid #7C3FBE;border-radius:18px;padding:1.5rem;margin:0.5rem 0;box-shadow:0 0 20px rgba(124,63,190,0.15);}
.p7-sent{color:#ffffff!important;font-size:1.85rem;font-weight:700;line-height:1.9;}
.p7-new{color:#E040FB;font-weight:900;font-size:1.9rem;text-shadow:0 0 8px rgba(224,64,251,0.4);}
.p7-qbox{background:linear-gradient(135deg,#1a0030,#280045);border:2px solid #E040FB;border-radius:18px;padding:1.5rem;margin:0.5rem 0;box-shadow:0 0 25px rgba(224,64,251,0.35);}
.p7-q{color:#FFD700;font-size:1.8rem;font-weight:800;line-height:1.8;}

/* 진행 표시 */
.p7-step{text-align:center;font-size:1.2rem;font-weight:900;color:#CC88FF;margin:0.3rem 0;}
.p7-hud{background:#060010;border:2px solid #7C3FBE;border-radius:14px;padding:0.8rem 1.2rem;margin:0.3rem 0;display:flex;justify-content:space-between;align-items:center;}
.p7-hud-l{font-size:1.3rem;font-weight:900;color:#E040FB;}
...
.p7-br-hl{color:#7C3FBE;font-weight:900;font-size:2.1rem;text-decoration:underline;text-underline-offset:5px;text-decoration-thickness:3px;}
.p7-br-kr{font-size:1.5rem;font-weight:600;color:#333;line-height:1.7;margin-bottom:0.5rem;}
.p7-br-ex{font-size:1.4rem;color:#333;line-height:1.6;padding:0.5rem 0.7rem;background:rgba(124,63,190,0.08);border-left:4px solid #9B59B6;border-radius:0 10px 10px 0;}

/* VICTORY/LOST 배너 */
.p7-ban{text-align:center;padding:0.8rem;border-radius:14px;margin:0.3rem 0;font-size:1.3rem;font-weight:900;}
.p7-ban-v{background:linear-gradient(135deg,#1a0030,#2a0050);color:#E040FB;border:2px solid #E040FB;box-shadow:0 0 16px rgba(224,64,251,0.3);}
.p7-ban-l{background:linear-gradient(135deg,#1a0010,#2a0020);color:#FF6666;border:2px solid #FF4444;}
...
if st.session_state.p7_phase == "lobby":
    ...
    .p7rmt-t{font-size:2.6rem;font-weight:900;
        background:linear-gradient(90deg,#7C3FBE,#CC88FF,#E040FB,#7C3FBE);
    ...
    .p7zn-t{background:linear-gradient(135deg,#050010,#080018);border:2px solid #2a0040;}
    .p7zn-b{background:linear-gradient(135deg,#080012,#0f001e);border:2px solid #7C3FBE;box-shadow:0 0 16px rgba(124,92,255,0.2);}
    .p7zn-n{background:linear-gradient(135deg,#050010,#080018);border:2px solid #200030;}
    .p7zl{font-size:1.8rem;font-weight:900;letter-spacing:6px;text-transform:uppercase;text-align:center;}
    .p7zl-t{color:#7755AA;}
    .p7zl-b{color:#CC88FF;}
    .p7zl-n{color:#553388;}

    .p7dis{text-align:center;background:linear-gradient(135deg,#100020,#1a0030);border:2px solid #4a1080;border-radius:50px;
        padding:20px;font-size:2.2rem;opacity:0.3;margin:14px 0;font-weight:900;color:#9B59B6;}

    button[kind="secondary"]{
        min-height:80px!important;border-radius:20px!important;
        font-size:2rem!important;font-weight:900!important;
        padding:20px 10px!important;color:#ffffff!important;
        background:linear-gradient(135deg,#0f0020,#18003a)!important;
    ...
    button[kind="secondary"]:hover{
        ...
        box-shadow:0 0 28px rgba(224,64,251,0.6)!important;
        border-color:#E040FB!important;
        background:linear-gradient(135deg,#200040,#30005a)!important;
    }
    ...
    # JS 색상 (로비)
    _sel60 = "border:3px solid #E040FB!important;box-shadow:0 0 20px rgba(224,64,251,0.5)!important;" if tsec==60 else ""
    _sel80 = "border:3px solid #E040FB!important;box-shadow:0 0 20px rgba(224,64,251,0.5)!important;" if tsec==80 else ""
    _sel100 = "border:3px solid #E040FB!important;box-shadow:0 0 20px rgba(224,64,251,0.5)!important;" if tsec==100 else ""
    _selA = "border:3px solid #E040FB!important;box-shadow:0 0 18px rgba(224,64,251,0.5)!important;" if cat=="article" else ""
    _selL = "border:3px solid #E040FB!important;box-shadow:0 0 18px rgba(224,64,251,0.5)!important;" if cat=="letter" else ""
    _selN = "border:3px solid #E040FB!important;box-shadow:0 0 18px rgba(224,64,251,0.5)!important;" if cat=="notice" else ""
    _selI = "border:3px solid #E040FB!important;box-shadow:0 0 18px rgba(224,64,251,0.5)!important;" if cat=="information" else ""

    components.html("""
    <script>
    function p7colors(){
        const doc=window.parent.document;
        // Fix ALL secondary buttons
        const btns=doc.querySelectorAll('button[kind="secondary"]');
        btns.forEach(btn=>{
            btn.style.setProperty('background','linear-gradient(135deg,#0f0020,#18003a)','important');
            btn.style.setProperty('border','2px solid #9B59B6','important');
            btn.style.setProperty('color','#ffffff','important');
            btn.style.setProperty('box-shadow','0 0 14px rgba(155,89,182,0.3)','important');
            const ps=btn.querySelectorAll('p,span,div');
            ps.forEach(p=>{
                p.style.setProperty('color','#ffffff','important');
                p.style.setProperty('text-shadow','none','important');
            });
        });
        // Fix passage text - force white
        const sents=doc.querySelectorAll('.p7-sent');
        sents.forEach(s=>{ s.style.setProperty('color','#ffffff','important'); });
    }
    setTimeout(p7colors,100);
    setTimeout(p7colors,400);
    setTimeout(p7colors,1000);
    setTimeout(p7colors,2500);
    const obs=new MutationObserver(()=>{setTimeout(p7colors,50);});
...
# ═══════════════════════════════════════
    ...
    bar_color = {"safe":"#9B59B6","warn":"#FFD600","danger":"#FF6B35","critical":"#FF0000"}[stage]
    bar_glow = {"safe":"rgba(155,89,182,0.5)","warn":"rgba(255,214,0,0.4)","danger":"rgba(255,107,53,0.5)","critical":"rgba(255,0,0,0.7)"}[stage]
    ...
    *{{margin:0;padding:0;}}body{{background:transparent;overflow:hidden;font-family:sans-serif;}}
    ...
    .hud-l{{font-size:1rem;font-weight:900;color:#E040FB;white-space:nowrap;}}
    ...
    for i, ch in enumerate(cur["choices"]):
        if st.button(ch, key=f"p7ch{step}_{i}", type="primary", use_container_width=True):
            ...
            try:
                ...
                _DC(st.session_state.get('nickname','guest')).log_activity('P7', str(st.session_state.get('p7_step','?')), -1, ok, 0)
            except: pass
    ...
    st.markdown("""<style>
    button[kind="primary"]{font-size:1.7rem!important;padding:0.7rem 1rem!important;min-height:auto!important;border-radius:12px!important;font-weight:900!important;background:linear-gradient(135deg,#0f0020,#1a0035)!important;border:2px solid #9B59B6!important;color:#fff!important;}
    button[kind="primary"] p{font-size:1.7rem!important;font-weight:900!important;color:#fff!important;}
    </style>""", unsafe_allow_html=True)
    ...
    function p7choiceColors(){
        ...
        btns.forEach(btn=>{
            ...
            if(txt.match(/[(]A[)]|[(]B[)]|[(]C[)]|[(]D[)]/)){
                btn.style.setProperty('background','linear-gradient(135deg,#0f0020,#1a0035)','important');
                btn.style.setProperty('border','2px solid #9B59B6','important');
                btn.style.setProperty('color','#ffffff','important');
                btn.style.setProperty('box-shadow','0 0 10px rgba(124,63,190,0.2)','important');
                btn.style.setProperty('border-radius','12px','important');
                const ps=btn.querySelectorAll('p,span');
                ps.forEach(p=>{
                    p.style.setProperty('color','#ffffff','important');
                });
            }
    ...
    setTimeout(p7choiceColors,100);
    setTimeout(p7choiceColors,500);
    setTimeout(p7choiceColors,1200);
    const obs2=new MutationObserver(()=>{setTimeout(p7choiceColors,50);});
...
# ═══════════════════════════════════════
    ...
    *{margin:0;padding:0;}body{background:#000;overflow:hidden;display:flex;align-items:center;justify-content:center;height:100vh;}
    ...
    .v h1{font-size:4.5rem;font-weight:900;color:#E040FB;text-shadow:0 0 40px #E040FB,0 0 80px #9B59B6;}
    .v p{font-size:1.5rem;color:#CC88FF;font-weight:700;margin-top:0.5rem;}
...
# ═══════════════════════════════════════
    ...
    if exprs:
        st.markdown('<div style="text-align:center;color:#E040FB;font-size:1.3rem;font-weight:900;margin:0.4rem 0;">💎 핵심 표현</div>', unsafe_allow_html=True)
        expr_html = ''
        for e in exprs:
            expr_html += f'<div style="background:#0a1a28;border:1px solid #00aacc;border-radius:12px;padding:0.7rem 1rem;margin:0.3rem 0;display:flex;justify-content:space-between;align-items:center;"><span style="color:#E040FB;font-size:1.8rem;font-weight:900;">{e["expr"]}</span><span style="color:#bbccdd;font-size:1.5rem;font-weight:700;">{e["meaning"]}</span></div>'
