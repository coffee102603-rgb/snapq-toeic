...
.ah{text-align:center;padding:0.05rem 0 0.05rem 0;}
...
.rd-dots{display:flex;justify-content:center;gap:0.6rem;margin:0.1rem 0;}
...
""", unsafe_allow_html=True)
    ...
    .stage{animation:stageIn 0.5s ease;border-radius:20px;padding:20px 12px;margin:8px 0;}
    ...
    .act-label{font-size:0.75rem;font-weight:900;letter-spacing:4px;color:#00d4ff;margin-bottom:10px;text-align:center;}
    .act-msg{font-size:1.3rem;font-weight:900;color:#fff;text-align:center;margin-bottom:14px;line-height:1.4;}
    ...
    .nav-bar-label{font-size:0.7rem;color:#333;text-align:center;letter-spacing:3px;margin-bottom:6px;}
    ...
    if rn > 1:
        ...
        round_txt = ''
    st.markdown(f'''<div class="ms-title">
        <h1>⚔️ P5 ARENA ⚔️</h1>
