...
# ════════════════════════════════════════
    ...
    if was_victory:
        ...
        _c1, _c2 = st.columns([2,1])
        with _c1:
            st.markdown('''<style>div[data-testid="stColumn"]:nth-child(1) button[kind="secondary"]{background:#0a0008!important;border:2px solid #cc2244!important;color:#ff4466!important;font-weight:900!important;}</style>''', unsafe_allow_html=True)
