...
def _svg_line(pts: list, color: str, w: int = 200, h: int = 45) -> str:
    """pts: [0~100 or None] 리스????SVG ?�인차트 문자??""
...
def _mini_bar(rate):
    """간단??�?그래??HTML"""
    if rate is None:
        return '<span style="color:#666;font-size:14px;">?�이???�음</span>'
    filled = int(rate / 10)
    bar = ""
    for i in range(10):
        h = 6 + (i * 2)
...
<div class="top-banner">
    ...
    <span class="banner-item">?�� 출석 {att_days}??/span>
    <span class="banner-divider">|</span>
    <span class="banner-item">??{total_time}</span>
    <span class="banner-divider">|</span>
    <span class="banner-rank">?�� ?�투참여??{ranking}</span>
</div>
""", unsafe_allow_html=True)
...
<div class="hub-brand">
    ...
    <div class="hub-brand-text">
        ...
        <div class="hub-platform">BATTLE LOBBY · ?�장???�택?�세??/div>
    </div>
</div>
""", unsafe_allow_html=True)
...
<div class="wel">
  <div class="wt">?�� 반�??�요, {student_name}??</div>
  <div class="ws">?�번??�??�속?�에??· ?�래 ?�장 �??�나�?골라 ?�작?�세???��</div>
</div>""", height=80)
else:
...
<div class="wel">
  <div class="wt">?�� ?�시 ?�군?? {student_name}??</div>
  <div class="ws">?�번??�?{_total}문제 ?�료 · ?�늘???????? ?��</div>
</div>""", height=80)
...
# P5 로테?�션 멘트 (??/??/??)
_P5_ROT = [
    ("?�험?��? ?�쟁?�다!", "?�하�??��? 마라!", "??30�?· 5문제 · 문법 ?�도??"),
    ("?�직???�리??", "?�쟁?�엔 ?�계 ?�다!", "??30�?· 5문제 · 지�?바로!"),
    ("문장 1개도 �??�으면서", "?�험??�?건�??", "??30�?· 5문제 · ?�리면 ?�락!"),
    ("?�력?� ?�습??만든??", "?�늘???�망치면 ?�일??같다!", "??30�?· 5문제 · ?�망치�? 마라!"),
    ("빠르�? ?�확?�게!", "그게 ?��???", "??30�?· 5문제 · ?�벽?�게!"),
]
# P7 로테?�션 멘트
_P7_ROT = [
    ("고득?? ?�하??", "그럼 지�?증명??", "?�� 60�?· 1지�?· 3문제 · ?�해 집중??"),
    ("?�용 ?�해 �??�면", "???�린다. 지문을 ?�어??", "?�� 60�?· 1지�?· 3문제 · ?�늘 ?�내!"),
    ("고득??", "말만 ?��? 말고 증명??", "?�� 60�?· 1지�?· 3문제 · ?�고 ?�내??"),
    ("지문을 ?��? ?�으�?, "찍는 것과 ?�름?�다!", "?�� 60�?· 1지�?· 3문제 · 집중?�라!"),
    ("?�해???�도가 ?�니??", "?�해가 ?��???", "?�� 60�?· 1지�?· 3문제 · ?�벽 ?�해!"),
]
# ??��??로테?�션 멘트
_ARM_ROT = [
    ("반복 P5문제 · 33�?· 5문제", "반복 P7?�휘 · 44�?· 10문제", "?���??�답 ?�욕?? ?�익 ??��! ?�생 ??��!"),
    ("???�?�나?", "반복만이 ?�길?�다!", "?���??�욕 �??�면 ??��???�다!"),
    ("?��?문제가", "?��? 기다린다!", "?���??�번??반드???�복?�라!"),
    ("?�답?� 기회??", "?�시 보면 반드???�다!", "?���???��???�작?� 지금이??"),
    ("?�기?�면 ?�하??", "?��?�??�수?????�른??", "?���??�까지 ?�워??"),
]
...
# ?�?� P5 ?�?�
_hc.html(_CSS + _GO_STYLE + _mk_card("p5c","??P5 ?�장",
...
# ?�?� P7 ?�?�
_hc.html(_CSS + _GO_STYLE + _mk_card("p7c","?�� P7 ?�장",
...
# ?�?� ??��???�?�
_hc.html(_CSS + _GO_STYLE + _mk_card("arc","?���???��??,
...
<div class="row">
  ...
  <div class="box box-adm" onclick="goAdmin()">
    <div class="ico">?��</div>
    <div class="lbl lbl-adm">관리자 ?�용</div>
  </div>
</div>
<script>
function goAdmin(){
