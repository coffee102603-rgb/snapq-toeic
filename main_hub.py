...
<div class="npc-ov" id="ov-p5-a"><div class="npc-sk">⚡</div><div class="npc-tx">화력전은 불이야.<br>빠르고 정확하게.<br>화력이 약하면 전멸이다!</div><div class="npc-stat">{_npc_p5_stat}</div></div><div class="npc-ov" id="ov-p5-b"><div class="npc-sk">⚡</div><div class="npc-tx">문법·어휘 전장.<br>불처럼 밀어붙여.<br>5문제 3개 생존.<br>느리면 죽는다!</div><div class="npc-stat">{_npc_p5_stat}</div></div>
    <div class="card-body">
...
<div class="npc-ov" id="ov-p7-a"><div class="npc-sk">📡</div><div class="npc-tx">지문 해독 임무.<br>1번 오판 = 즉시 철수.<br>집중 = 승리.</div><div class="npc-stat">{_npc_p7_stat}</div></div><div class="npc-ov" id="ov-p7-b"><div class="npc-sk">📡</div><div class="npc-tx">적군 문서 해독.<br>지문 속 단서가 답이야.<br>읽어야 산다.</div><div class="npc-stat">{_npc_p7_stat}</div></div>
    <div class="card-body">
      <div class="badge">독해</div>
      <img src="data:image/png;base64," style="width:50px;height:50px;border-radius:50%;margin:4px 0;">
...
<div class="npc-ov" id="ov-pow-a"><div class="npc-sk">💀</div><div class="npc-tx">네가 틀린 문제 여기 갇혔어.<br>문법은 약점, 문장읽기는 구멍.<br>여기서 끝내.</div><div class="npc-stat">{_npc_pow_stat}</div></div><div class="npc-ov" id="ov-pow-b"><div class="npc-sk">💀</div><div class="npc-tx">화력전서 놓친 문법.<br>암호해독서 못 읽은 문장.<br>다 여기 있어. 이번엔 정복해.</div><div class="npc-stat">{_npc_pow_stat}</div></div>
    <div class="pow-left">
