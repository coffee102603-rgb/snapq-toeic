...
# ============================================================
# SNAPQ P7 READING ARENA - ZERO TOP GAP (WRAPPER v3.2)
# - Keep arena untouched
# - Pin HUD + Gauge to top
# - Pull battlefield upward (minimal reserved space)
# ============================================================
...
/* ===== REAL HUD+GAUGE FIX ===== */
:root{
  --p7HudH: 46px;    /* HUD 높이 (타이트) */
  --p7GaugeH: 10px;  /* 게이지 높이 */
}
...
def main():
    try:
        st.set_page_config(
            page_title="SnapQ P7 Reading Arena (ZERO GAP v3.2)",
            page_icon="🔥",
            layout="wide",
