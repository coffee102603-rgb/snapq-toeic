...
# --- P7_BUILD_TAG_20260206_200038 (VISIBLE PROBE) ---
try:
    import streamlit as st
    st.markdown(f'''
    <style>
    ...
    <div class="p7-build-probe">✅ { "P7_BUILD_TAG_20260206_200038" } / FILE PROBE ACTIVE</div>
    ''', unsafe_allow_html=True)
except Exception:
    pass
# --- /P7_BUILD_TAG_20260206_200038 ---
# === P7_HAS_FLAG ===
...
# --- P7_TEXT_SHRINK_V4 (CSS LAST FORCE) ---
import streamlit as st
# --- P7_BUILD_TAG_20260206_200038 (VISIBLE PROBE) ---
try:
    import streamlit as st
...
st.markdown("""
<style>
/* === P7_TEXT_SHRINK_V4 : PASSAGE + QUESTION ONLY === */
/* 적용 확인용: 카드에 초록 테두리(눈에 띄게) */
.p7-card, .p7-q-title, .p7-zone-body{
  outline: 3px solid rgba(0,255,120,0.85) !important;
  outline-offset: -6px !important;
}

/* 실제 축소: 지문/문제 영역 안의 텍스트만 강제 px로 줄이기 (em 의존 X) */
.p7-card *, 
.p7-zone-body *,
.p7-q-title *,
.p7-question *, 
.p7-qtext *{
  font-size: 19px !important;   /* 22px 기준 -15% 정도 */
  line-height: 1.45 !important;
}

/* Streamlit markdown container까지 강제 */
