...
# --- AUTO PATCH: ZERO GAP v2.1 SCROLL FIX ---
import streamlit as st  # noop

<style>
/* ===================== ZERO GAP v2.1 SCROLL FIX (LAST WINS) ===================== */
/* Keep top UI hidden */
header[data-testid="stHeader"],
div[data-testid="stToolbar"],
div[data-testid="stDecoration"],
...
/* ✅ 핵심: 문서 전체는 숨기되, MAIN 영역은 스크롤 가능하게 */
html, body{
  height:100% !important;
  margin:0 !important;
  padding:0 !important;
...
div[data-testid="stAppViewContainer"] > section > main{
  height:100vh !important;
  overflow:auto !important;      /* <-- 여기로 모든 스크롤을 받는다 */
}
.block-container{
  min-height:100vh !important;
  overflow:visible !important;   /* 콘텐츠가 어디에 렌더되든 보이게 */
...
/* p7-battlefield가 있으면 그 안도 스크롤 OK (이중 스크롤 방지 위해 높이 강제는 하지 않음) */
.p7-battlefield{
  overflow-y:auto !important;
  overflow-x:hidden !important;
  margin-top:0 !important;
