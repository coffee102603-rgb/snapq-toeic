...
"""
    ...
    hub_btn = "<button class=\"p7-hub-btn\" onclick=\"window.location.href='/'\">🏠 MAIN HUB</button>"

    st.markdown(
    textwrap.dedent(
        f"""<div class="p7-hudbar">
...
<div class="p7-hud-right">{hub_btn}</div>
</div>"""
    ),
    unsafe_allow_html=True,
)
...
/* Options (radio cards) — prevent double scaling */
div[role="radiogroup"] > label{
  font-size: 1em !important; /* reset */
}
div[role="radiogroup"] > label p,
div[role="radiogroup"] > label span,
div[role="radiogroup"] > label strong,
div[role="radiogroup"] > label em,
...
div[role="radiogroup"] > label [data-testid="stMarkdownContainer"] span{
  font-size: 1.2em !important; /* +20% only */
}

/* Options (button type, if used) */
.p7-opt-wrap div[data-testid="stButton"] > button,
.p7-opt-wrap div[data-testid="stButton"] > button *{
  font-size: 1.2em !important;
}
