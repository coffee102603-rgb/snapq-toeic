...
# ============================================================
# SNAPQ P7 READING ARENA - ZERO TOP GAP (WRAPPER v3.3)
# - Keep app/arenas/p7_reading_arena.py untouched
# - Fix "drifting downward" by making .p7-battlefield the ONLY scroll area
# ============================================================
...
/* Make the whole document NOT scroll (prevents drift feel) */
html, body{
...
/* HUD fixed (explicit height so it doesn't "change" on rerun) */
.p7-hud-compact{
...
/* ✅ Battlefield becomes the ONLY scroll container */
.p7-battlefield{
...
def main():
    try:
        st.set_page_config(
            page_title="SnapQ P7 Reading Arena (ZERO GAP v3.3)",
            page_icon="🔥",
            layout="wide",
    ...
    # small fixed badge (no layout impact)
    st.markdown(
