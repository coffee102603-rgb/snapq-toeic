...
# === SNAPQ_ARMORY_LOADED_STAMP ===
import streamlit as st  # SNAPQ_ARMORY_LOADED_STAMP
st.warning(f"✅ SECRET_ARMORY LOADED FROM: {__file__} | ROOT_BUILD_20260129_081323")  # SNAPQ_ARMORY_LOADED_STAMP
# === /SNAPQ_ARMORY_LOADED_STAMP ===
# ------------------------------------------------------------
