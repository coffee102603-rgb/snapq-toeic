...
# --- P7_GREEN_OVERLAY_DIAG_V1 START ---
import streamlit as st
st.markdown(r"""
<style>
/* ===== P7_GREEN_OVERLAY_DIAG_V1 ===== */

/* 화면 전체를 덮는 '초록 오버레이' (핑크가 위에 남는지 판별용) */
.p7-green-overlay{
  position: fixed;
  inset: 0;
  z-index: 999998;
...
/* 오버레이가 제대로 깔리도록, 루트 배경도 초록 기운으로 강제 */
html, body, .stApp,
...
<div class="p7-green-overlay"></div>
""", unsafe_allow_html=True)
# --- P7_GREEN_OVERLAY_DIAG_V1 END ---
