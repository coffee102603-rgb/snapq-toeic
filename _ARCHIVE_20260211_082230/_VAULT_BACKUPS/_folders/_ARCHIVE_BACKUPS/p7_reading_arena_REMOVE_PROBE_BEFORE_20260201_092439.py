...
# ===== P7_REALFILE_BADGE_END =====
    ...
    # ===== P7_VIEWPORT_LOCK_FINAL_BEGIN =====
    try:
        st.markdown(r"""
        <style>
        /* =========================================================
           P7 VIEWPORT LOCK FINAL (GAME MODE)
           - BODY(문서) 스크롤 OFF  => "아래 빈 그라데이션" 원천 제거
           - 전장(.p7-battlefield) 내부 스크롤 ON
           - HUD top:0 고정 유지
           ========================================================= */
        ...
        .p7-battlefield{
          ...
          padding-top: 0 !important;
          padding-bottom: 24px !important; /* 맨 아래 UI 숨김 방지 */
        }
        </style>
        """, unsafe_allow_html=True)
    except Exception:
        pass
    # ===== P7_VIEWPORT_LOCK_FINAL_END =====

    # ===== P7_SAFE_REALFILE_BEGIN =====
    try:
        import os as _os
        st.markdown(r"""
        <style>
        ...
        # ✅ 경로는 런타임에서 계산 (문자열에 C:\... 박지 않음)
        st.markdown(f"<div class='p7-realfile-overlay'>🔎 P7 REAL FILE: {_os.path.abspath(__file__)}</div>",
                    unsafe_allow_html=True)
    except Exception:
        pass
    # ===== P7_SAFE_REALFILE_END =====
