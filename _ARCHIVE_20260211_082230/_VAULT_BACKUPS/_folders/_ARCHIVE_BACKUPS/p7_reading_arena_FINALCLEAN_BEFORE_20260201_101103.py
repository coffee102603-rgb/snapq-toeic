...
# ===== P7_REALFILE_BADGE_END =====
    ...
    # ===== P7_TOPSPACE_FINAL_SAFE_BEGIN =====
    try:
        st.markdown(r"""
        <style>
        /* P7 TOPSPACE FINAL SAFE (CSS ONLY) */

        :root{
          --p7-hud-h: 64px;        /* 필요시 56~72 */
          --p7-topshift: -120px;   /* '위 빈공간' 당김 강도. -80 ~ -180 사이에서 조절 */
        }

        /* streamlit 상단 패딩/여백 제거 */
        header[data-testid="stHeader"],
        div[data-testid="stToolbar"],
        div[data-testid="stDecoration"],
        footer { display:none !important; height:0 !important; margin:0 !important; padding:0 !important; }
        ...
        /* ✅ 핵심: 전장 전체를 위로 끌어올려서 '상단 빈공간'을 제거 */
        .p7-battlefield{
          margin-top: calc(var(--p7-hud-h) + var(--p7-topshift)) !important;
          padding-top: 0 !important;
        }
        </style>
        """, unsafe_allow_html=True)
