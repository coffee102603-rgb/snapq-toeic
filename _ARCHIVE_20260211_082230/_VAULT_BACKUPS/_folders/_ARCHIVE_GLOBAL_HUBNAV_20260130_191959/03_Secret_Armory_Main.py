...
# ============================================================
# SnapQ TOEIC :: Secret Armory Lobby (A안: 2카드/4버튼 + 하단 Main Hub)
# - 구조/로직: 기존과 동일 (switch_page 경로 동일)
# - UI만: Main Hub 감성(PC방 전장)으로 통일
# - Mobile: 2열 → 자동 세로 스택(안전)
# ============================================================
...
st.set_page_config(
    page_title="🗡 Secret Armory Lobby",
    page_icon="🗡",
    layout="wide",
