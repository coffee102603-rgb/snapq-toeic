...
def inject_css():
    ...
    st.markdown(f"""
        <style>
        /* ===== P7 CRIT (ALWAYS) ===== */
/* P7_FONT_UNIFY_V1 START */
/* ✅ 전역: outline/box-shadow/핑크 디버그 테두리 제거 */
...
/* 혹시 style 속성으로 hotpink 계열이 박혀있으면 제거 */
*[style*="hotpink"], *[style*="magenta"], *[style*="fuchsia"],
*[style*="#ff00ff"], *[style*="#f0f"], *[style*="rgb(255,0,255)"], *[style*="deeppink"]{{
  outline: none !important;
  box-shadow: none !important;
  border: 0 !important;
...
# DISABLED_BY_VIEWPORT_LOCK[TOPSPACE_FORCE_V9]         st.markdown(f"""
...
# DISABLED_BY_VIEWPORT_LOCK[P7_FORCE_TOP_KILL]     st.markdown(fr"""
...
# DISABLED_BY_VIEWPORT_LOCK[P7_LAYOUT_V10]         st.markdown(f"""
