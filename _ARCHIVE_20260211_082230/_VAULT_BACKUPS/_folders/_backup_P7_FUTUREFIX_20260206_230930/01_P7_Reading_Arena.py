...
/* ✅ 분홍/핫핑크/디버그 테두리: outline + border + shadow 전부 제거 */
html, body, .stApp, .main,
[data-testid="stAppViewContainer"], [data-testid="stMain"],
.block-container, .st-emotion-cache-1y4p8pa, .st-emotion-cache-uf99v8{
...
/* 혹시 style 속성으로 hotpink 류가 박혀있으면 강제 제거 */
