...
.card .sub{ color:#3b4252; font-weight:800; }
.card .big{ font-size:22px; font-weight:950; }
.chip{
  display:inline-block; padding:6px 10px; border-radius:999px;
  background: rgba(24,160,251,.12); border:1px solid rgba(24,160,251,.25);
...
.hud .row b{ color:#fff; }
.hud .row span{ color:#d3d9ea; font-weight:900; }
</style>
