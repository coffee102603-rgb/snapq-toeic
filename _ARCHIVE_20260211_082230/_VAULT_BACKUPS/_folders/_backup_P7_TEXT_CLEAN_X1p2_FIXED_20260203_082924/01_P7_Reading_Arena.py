...
/* ===== P7_TEXT_SCALE_X1P2_ONLY_FINAL (SAFE / TEXT ONLY) ===== */
/* DO NOT touch layout/timer/hud/padding/margins/cards */
.p7-zone .p7-zone-body{ font-size: 26.4px !important; }
.p7-zone.mission .p7-zone-body{ font-size: 27.6px !important; }
.p7-opt-wrap div[data-testid="stButton"] > button{ font-size: 26.4px !important; }
@media (max-width: 640px){
  .p7-zone .p7-zone-body{ font-size: 24px !important; }
  .p7-zone.mission .p7-zone-body{ font-size: 24px !important; }
  .p7-opt-wrap div[data-testid="stButton"] > button{ font-size: 25.2px !important; }
}
/* ===== /P7_TEXT_SCALE_X1P2_ONLY_FINAL ===== */
/* ===== P7_TEXT_SCALE_X1P2_FORCE (TEXT ONLY) ===== */
/* passage + question (dark pill blocks) */
.p7-zone .p7-zone-body,
.p7-zone .p7-zone-body *{
  font-size: 1.2em !important;
}

/* options: st.radio cards */
div[role="radiogroup"] > label,
div[role="radiogroup"] > label *{
  font-size: 1.2em !important;
}

/* options: if any buttons are used */
.p7-opt-wrap div[data-testid="stButton"] > button,
.p7-opt-wrap div[data-testid="stButton"] > button *{
  font-size: 1.2em !important;
}
/* ===== /P7_TEXT_SCALE_X1P2_FORCE ===== */
/* ===== P7_TEXT_x1p2_TUNED_V2 (TEXT ONLY) ===== */
/* 1) Passage + Question: +20% */
.p7-zone .p7-zone-body,
...
/* 2) Options (radio cards): prevent double scaling
   - reset label base to 1.0x
   - then scale ONLY text inside to 1.2x
*/
div[role="radiogroup"] > label{
...
/* 3) Options (button type, if used) */
.p7-opt-wrap div[data-testid="stButton"] > button,
.p7-opt-wrap div[data-testid="stButton"] > button *{
  font-size: 1.2em !important;
}
/* ===== /P7_TEXT_x1p2_TUNED_V2 ===== */
</style>
