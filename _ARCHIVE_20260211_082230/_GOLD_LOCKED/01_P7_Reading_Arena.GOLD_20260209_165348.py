...
/* ===== /P7_FORCE_TOPCSS_V1 V2 ===== */
  ...
  /* ===== P7_REWARD_DOM_SAFE_CSS_V1 (STREAMLIT DOM-SAFE) ===== */
  div[data-testid="stMarkdownContainer"]:has(#p7-reward-anchor) ~ div div[data-testid="stTabs"] *{
    font-size: 14px !important;
    line-height: 1.25 !important;
  }
  div[data-testid="stMarkdownContainer"]:has(#p7-reward-anchor) ~ div div[data-testid="stAlert"] *{
    font-size: 14px !important;
    line-height: 1.25 !important;
  }
  div[data-testid="stMarkdownContainer"]:has(#p7-reward-anchor) ~ div h1{ font-size: 22px !important; }
  div[data-testid="stMarkdownContainer"]:has(#p7-reward-anchor) ~ div h2{ font-size: 20px !important; }
  div[data-testid="stMarkdownContainer"]:has(#p7-reward-anchor) ~ div h3{ font-size: 18px !important; }
  div[data-testid="stMarkdownContainer"]:has(#p7-reward-anchor) ~ div button[role="tab"] *{
    font-size: 14px !important;
    font-weight: 900 !important;
  }
  /* ===== /P7_REWARD_DOM_SAFE_CSS_V1 ===== */
/* ===== /P7_END_BUTTONS_ANCHOR_CSS_V1 ===== */
</style>
