...
.block-container{padding-top:0 !important; margin-top:0 !important; max-width:100% !important; padding-left:10px !important; padding-right:10px !important;}
...
def main():
    try:
        st.set_page_config(page_title="P7 Wrapper Active", page_icon="🔥", layout="wide", initial_sidebar_state="collapsed")
    except Exception:
        pass
    ...
    def patched_inject_css():
        try:
            if callable(old_inject): old_inject()
        except Exception:
            pass
        _inject_css_min()
        _force_scroll_top()
